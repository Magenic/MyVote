...
module MyVote.Services {
    ...
    export class MyVoteService {
        ...
        public getUser(userProfileId: string): ng.IPromise<MyVote.AppServer.Models.User> {
        ...
        public saveUser(user: MyVote.AppServer.Models.User): ng.IPromise<MyVote.AppServer.Models.User> {
            var deferred = this._q.defer();
        ...
        public getPolls(filterBy: string): ng.IPromise<MyVote.AppServer.Models.PollSummary[][]> {
            var deferred = this._q.defer();
            ...
            var polls = (this._pollResource.query(
                ...
                () => {
                    ...
                    for (var i = 0; i < (<any>polls).length; i++) {
                        var poll: MyVote.AppServer.Models.PollSummary = polls[i];
        ...
        public getPoll(id: number): ng.IPromise<MyVote.AppServer.Models.Poll> {
            var deferred = this._q.defer();
        ...
        public savePoll(poll: AppServer.Models.Poll): ng.IPromise<MyVote.AppServer.Models.Poll> {
            var deferred = this._q.defer();
        ...
        public submitResponse(response: MyVote.AppServer.Models.PollResponse): ng.IPromise<string> {
            var deferred = this._q.defer();
        ...
        public getPollResponse(pollId: number, userId: number): ng.IPromise<MyVote.AppServer.Models.PollInfo> {
            var deferred = this._q.defer();
        ...
        public getPollResult(pollId: number): ng.IPromise<MyVote.AppServer.Models.PollResult> {
            var deferred = this._q.defer();
