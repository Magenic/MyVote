# Lifted from: http://lucidsnippets.com/blog/powershell-to-delete-bin-obj-folders/
# Script that recursively deletes all 'bin' and 'obj' (or any other specified) folders inside current folder
