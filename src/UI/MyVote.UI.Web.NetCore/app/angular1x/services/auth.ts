...
module MyVote.Services {
    ...
    export class AuthService {
        ...
        private static _client: Microsoft.WindowsAzure.MobileServiceClient = new WindowsAzure.MobileServiceClient('https://mbl-myvote.azurewebsites.net/');
        ...
        public providers: Models.AuthProvider[] = [
            new Models.AuthProvider('twitter', 'Twitter', '/app/shared/content/twitter.png', '#01abdf'),
            new Models.AuthProvider('facebook', 'Facebook', '/app/shared/content/fb.png', '#3d509f'),
            new Models.AuthProvider('microsoftaccount', 'Microsoft', '/app/shared/content/ms.png', '#fff'),
            new Models.AuthProvider('google', 'Google', '/app/shared/content/google.png', '#dc021e')
        ];
