...
declare module MyVote.Services.AppServer.Models {
	...
	interface Poll {
		...
		PollOptions: MyVote.Services.AppServer.Models.PollOption[];
	}
	...
	interface PollResponse {
		...
		UserID: number;
		Comment: string;
		ResponseItems: MyVote.Services.AppServer.Models.ResponseItem[];
	}
	...
	interface PollResult {
		...
		PollImageLink: string;
		Question: string;
		Results: MyVote.Services.AppServer.Models.PollResultItem[];
		Comments: MyVote.Services.AppServer.Models.PollResultComment[];
	}
	...
	interface PollInfo {
		...
		SubmissionDate: Date;
		Comment: string;
		PollOptions: MyVote.Services.AppServer.Models.PollResponseOption[];
	}
